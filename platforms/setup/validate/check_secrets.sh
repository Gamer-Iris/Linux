...
SECRETS_DIR="${1:-platforms/kubernetes/apps/secrets}"
SETTINGS_TEMPLATE="platforms/settings/settings_secret_template.yml"
SETTINGS_FILE="platforms/settings/settings_secret.yml"
FAILED=0
CHECKED=0
