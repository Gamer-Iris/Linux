...
# 環境変数設定
## DB関連
DATABASES_OSS=`cat ~/Linux/platforms/settings/settings_secret.yml | yq eval '.databases.oss'`
...
DATABASES_DATABASE3_DATABASENAME=`cat ~/Linux/platforms/settings/settings_secret.yml | yq eval '.databases.database3.databasename'`
DATABASES_DATABASE3_USERNAME=`cat ~/Linux/platforms/settings/settings_secret.yml | yq eval '.databases.database3.username'`
DATABASES_DATABASE3_PASSWORD=`cat ~/Linux/platforms/settings/settings_secret.yml | yq eval '.databases.database3.password'`
## ワークフォルダ
