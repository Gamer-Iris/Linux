...
# エラーメッセージ設定
ERR_MESSAGE_01="updateに失敗しました。"
ERR_MESSAGE_02="upgradeに失敗しました。"
ERR_MESSAGE_03="autoremoveに失敗しました。"
ERR_MESSAGE_04="cleanに失敗しました。"
ERR_MESSAGE_05="autocleanに失敗しました。"
ERR_MESSAGE_06="checkに失敗しました。"
...
#*****************************************************************************************************************************************************
    "STEP050")
      ...
      # EXEC------------------------------------------------------------------------------------------------------------------------------------------
      RESULT=$(sudo apt-get autoclean -y)
      # RETURN----------------------------------------------------------------------------------------------------------------------------------------
      RTN_CD=$?
      if [ -n "${RESULT}" ]; then
        log "${RESULT}"
